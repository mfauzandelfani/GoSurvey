...
class Auth extends CI_Controller
{
    ...
    private function sendEmail($token, $type)
    {
        ...
        if ($type == 'verify') {
            ...
            $this->email->message('Silahkan Klik link untuk aktivasi akun : 
            <a href="' . base_url() . 'login/auth/verify?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '"> Aktivasi </a>');
        } else if ($type == 'forgot') {
