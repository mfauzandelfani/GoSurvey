...
class topup_ctrl extends CI_Controller
{
    ...
    public function editaction()
    {
        ...
        if ($this->Pgn_model->ubahdatatopup($data, $id) == TRUE) {
        ...
        // var_dump($data);
        // die;
        redirect(base_url('Admin/topup_ctrl'));
